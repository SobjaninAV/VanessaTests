...
* Выбор груза
	...
	//	| '$Номер заказа$' | 'Собянин Антон' | '20'     | '20'        | 'Аукцион'     | 'г Москва, Россия' | 'Гофрокартон' | 'г Березники, Пермский край, Россия' | '1'                | '60 000'                | 'Новый'  | '50 000'                  | 'Собянин Антон' | 'Отдел Логистики' |
...
* Запуск аукциона
	...
	//Тогда таблица 'Список' содержит строки:
	//	| 'Заказ №'     | 'Автор'         | 'Вес, т' | 'Объем, м³' | 'Тип Закупки' | 'Погрузка'         | 'Груз'        | 'Разгрузка'                          | 'Количество машин' | 'Плановая ставка с НДС' | 'Статус' | 'Плановая ставка Без НДС' | 'Менеджер'      | 'Подразделение'   |
	//	| '$Номер заказа$' | 'Собянин Антон' | '20'     | '20'        | 'Аукцион'     | 'г Москва, Россия' | 'Гофрокартон' | 'г Березники, Пермский край, Россия' | '1'                | '60 000'                | 'Идет аукцион'  | '50 000'                  | 'Собянин Антон' | 'Отдел Логистики' |
